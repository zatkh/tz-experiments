...
srcs-y  +=	s_copysignl.c s_fabsl.c s_llrintl.c s_lrintl.c s_modfl.c

# If long double != double use these; otherwise, we alias the double versions.
srcs-y  +=	e_acosl.c e_asinl.c e_atan2l.c e_fmodl.c \
...
srcs-y  +=	s_ccosh.c s_ccoshf.c s_cexp.c s_cexpf.c \
