			      ...
			      TEE_Param params[TEE_NUM_PARAMS])
{
	...
	msg_params[1].u.value.a = params[0].value.b; 
	msg_params[1].u.value.b = params[2].value.a; 
	msg_params[1].u.value.c = params[0].value.a; 
			      ...
			      TEE_Param params[TEE_NUM_PARAMS])
{
	...
	msg_params[2].u.value.a = params[0].value.b ;
	res = thread_rpc_cmd(OPTEE_MSG_RPC_CMD_SOCKET, 3, msg_params);
	params[2].value.a = msg_params[2].u.value.b; 
	return res;
}
